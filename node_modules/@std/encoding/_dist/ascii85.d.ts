...
/** Options for {@linkcode encodeAscii85} and {@linkcode decodeAscii85}. */ export interface Ascii85Options {
  /**
 ...
 * ```
 */ export declare function encodeAscii85(data: ArrayBuffer | Uint8Array | string, options?: Ascii85Options): string;
/**
 ...
 * );
 * ```
 */ export declare function decodeAscii85(ascii85: string, options?: Ascii85Options): Uint8Array;
