...
export type NostrRelayCOUNT = ['COUNT', subscriptionId: string, {
    count: number;
    approximate?: boolean;
}];
...
export type NostrRelayMsg = NostrRelayEVENT | NostrRelayOK | NostrRelayEOSE | NostrRelayCLOSED | NostrRelayNOTICE | NostrRelayCOUNT | NostrRelayAUTH;
